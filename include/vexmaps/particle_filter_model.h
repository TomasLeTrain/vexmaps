...
namespace vexmaps {
    ...
    class ParticleFilterModel : public LocalizationModel {
        ...
        void init() override {
            particle_filter.initUniform(-1.78308_m, -1.78308_m, 1.78308_m, 1.78308_m);
        }
        ...
        void setPose(units::Pose new_pose) override {
            particle_filter.init_normal_around_point({new_pose.x,new_pose.y}, set_pose_normal_deviation);
        }
