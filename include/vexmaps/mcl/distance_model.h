...
namespace vexmaps {
    class DistanceSensorModel : public Sensor {
        ...
        DistanceSensorModel(const units::Pose offset, pros::Distance * distance_sensor,std::string name)
        ...
        // could be used to generate particles in case of total system collapse
